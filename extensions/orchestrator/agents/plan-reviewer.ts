...
export function createPlanReviewerAgent(
  ...
  return {
    ...
    prompt: [
      ...
      "Your review MUST begin with the verdict on the VERY FIRST LINE: `VERDICT: APPROVE` or `VERDICT: REJECT`, and the final review MUST end with a line `REVIEW_STATUS: COMPLETE`.",
      "</constraints>",
      "",
      PRINCIPLES_BLOCK,
      "",
    ...
    "Spawn multiple explore agents in parallel for broad searches. Do NOT spawn task, advisor, deep-debugger, or reviewer.",
      ...
      "",
      // --- dynamic suffix ---
      "# MANDATORY OUTPUT FILE (stub FIRST, final review LAST)",
      "",
