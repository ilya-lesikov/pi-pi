...
export const DELEGATION_BLOCK = [
  ...
  "  advisor=opus, advisor2=gpt, advisor3=gemini; default to a family differing from your own,",
  "  and escalate to a second/third advisor for hard or high-stakes calls.",
  ...
  "- deep-debugger for a trivial/obvious error, or an advisor for a plain lookup.",
