...
export function brainstormSystemPrompt(taskType: TaskType, taskDescription: string, taskDir: string): string {
  if (taskType === "debug") {
    return [
      ...
      "4. Use lsp goToDefinition, findReferences, hover, and diagnostics to trace the bug",
      "5. Do NOT modify project source code (no write or edit tools)",
      "",
  ...
  return [
    ...
    "4. Use lsp documentSymbol, goToDefinition, findReferences to understand code structure",
