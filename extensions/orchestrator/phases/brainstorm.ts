...
export function brainstormSystemPrompt(taskType: TaskType, taskDescription: string, taskDir: string): string {
  ...
  if (taskType === "brainstorm") {
    return [
      ...
      "2. Spawn explore/librarian subagents for codebase and external research",
      "3. Use tools to understand code structure (cbm_search, lsp, ast_search, etc.)",
      "4. Discuss approaches, tradeoffs, and decisions with the user",
