...
export function reviewSystemPrompt(taskDir: string, round: number, manualReview = false): string {
  ...
  return [
    ...
    "- Do NOT check the reviews directory yourself — wait for the notification that all reviewers completed.",
    ...
    "1. Wait for the notification that says 'N code reviewer(s) completed' — do NOT proceed before this",
