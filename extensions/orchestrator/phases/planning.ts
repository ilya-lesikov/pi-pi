...
export function planningSystemPrompt(taskDir: string): string {
  ...
  return [
    ...
    "- Do NOT check the plans directory yourself — call pp_wait to block until all planners complete.",
    ...
    "1. Call pp_wait — this blocks until all planner subagents complete. Do NOT poll the directory.",
