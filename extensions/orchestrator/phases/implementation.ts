export function implementationSystemPrompt(taskDir: string, cwd: string): string {
  return [
    ...
    "and no `BREAKING CHANGE:` trailer. Keep the body to at most 2 short paragraphs — no more than 3 sentences",
    "each, ~500 characters total; omit the body entirely unless it adds rationale the subject line can't carry.",
